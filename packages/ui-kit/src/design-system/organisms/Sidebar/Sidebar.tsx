            ...
            >
                <div className="flex flex-col h-full justify-between">
                    ...
                    <div className="p-4 border-t border-white/10 flex flex-col gap-2">
                        ...
                        >
                            {isCollapsed ? React.createElement(ChevronRight as React.ElementType, { size: 20 }) : React.createElement(ChevronLeft as React.ElementType, { size: 20 })}
                        ...
                        >
                            <span title="Log Out">
                                {React.createElement(LogOut as React.ElementType, { size: 20 })}
                            </span>
