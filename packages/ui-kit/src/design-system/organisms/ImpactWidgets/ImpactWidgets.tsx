            ...
            >
                ...
                <div className="flex flex-col bg-white border border-gray-200 shadow-sm">
                    ...
                    <div className="p-0">
                        {recentActivity.map((activity) => (
                            <div key={activity.id} className="flex gap-4 p-5 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                                <div className="mt-1">
                ...
                <div className="flex flex-col gap-3">
                    <ReportIssueCard
                        ...
                        href="#"
                    // Using different icon is tricky without prop, but `ReportIssueCard` is specific. 
                    // Maybe reusing it is OK or I should make a generic `ActionCard`?
                    // For now, I'll stick to `ReportIssueCard` but the icon is fixed to AlertTriangle.
                    // Actually `ReportIssueCard` has specific icon. 
                    // I will use `ReportIssueCard` for "Report an Issue" and maybe just a styled link for Calendar for now 
                    // OR I should have made `ActionCard`. 
                    // Given the plan "ReportIssueCard: Specialized card/button defined for reporting issues", 
                    // I will use it for "Report an Issue". 
                    // For "View Shop Calendar", I'll just render it inline here to match design 
                    // or if needed I can refactor `ReportIssueCard` to be generic `ActionCard`. 
                    // Let's refactor `ReportIssueCard` to accept Icon? No, strictly following plan.
                    // I'll render "View Shop Calendar" manually here matching the style.
                    />
                    <ReportIssueCard />
