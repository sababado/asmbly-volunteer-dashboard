...
describe('TaskListItem', () => {
    it('renders task details', () => {
        render(<TaskListItem title="Fix Saw" description="Broken" area="wood" urgency="high" duration="1h" status="ready"/>);
    ...
    it('calls onClaim when button clicked', () => {
        ...
        render(<TaskListItem title="T" description="D" area="wood" urgency="low" duration="1h" status="open" onClaim={handleClaim}/>);
